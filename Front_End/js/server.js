...
app.post("/analyze-video", async (req, res) => {
  try {
    ...
    const fastApiResponse = await axios.post(`${process.env.FASTAPI_URL}/analyze`, { videoUrl });

    res.json({ message: "Video processed successfully", analysis: fastApiResponse.data });
  } catch (error) {
